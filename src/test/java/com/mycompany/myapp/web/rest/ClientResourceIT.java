...
class ClientResourceIT {
    ...
    private static final Integer DEFAULT_I_D_CLIENT = 1;
    private static final Integer UPDATED_I_D_CLIENT = 2;
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getiDClient()).isEqualTo(DEFAULT_I_D_CLIENT);
        assertThat(testClient.getDateAjout()).isEqualTo(DEFAULT_DATE_AJOUT);
        ...
        assertThat(testClient.getCodePostale()).isEqualTo(DEFAULT_CODE_POSTALE);
    }
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].iDClient").value(hasItem(DEFAULT_I_D_CLIENT)))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.iDClient").value(DEFAULT_I_D_CLIENT))
    ...
    void putNewClient() throws Exception {
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getiDClient()).isEqualTo(UPDATED_I_D_CLIENT);
        assertThat(testClient.getDateAjout()).isEqualTo(UPDATED_DATE_AJOUT);
        ...
        assertThat(testClient.getCodePostale()).isEqualTo(UPDATED_CODE_POSTALE);
    }
