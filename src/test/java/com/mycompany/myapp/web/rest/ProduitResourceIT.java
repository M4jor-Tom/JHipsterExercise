...
class ProduitResourceIT {
    ...
    private static final Integer DEFAULT_I_D_PRODUIT = 1;
    private static final Integer UPDATED_I_D_PRODUIT = 2;
    ...
    private static final Integer DEFAULT_PHOTO = 1;
    private static final Integer UPDATED_PHOTO = 2;
    ...
    void createProduit() throws Exception {
        ...
        assertThat(testProduit.getiDProduit()).isEqualTo(DEFAULT_I_D_PRODUIT);
        assertThat(testProduit.getNom()).isEqualTo(DEFAULT_NOM);
        assertThat(testProduit.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testProduit.getPhoto()).isEqualTo(DEFAULT_PHOTO);
        assertThat(testProduit.getStock()).isEqualTo(DEFAULT_STOCK);
        assertThat(testProduit.getTags()).isEqualTo(DEFAULT_TAGS);
        assertThat(testProduit.getTarif()).isEqualTo(DEFAULT_TARIF);
    }
    ...
    void getAllProduits() throws Exception {
        ...
        restProduitMockMvc
            ...
            .andExpect(jsonPath("$.[*].iDProduit").value(hasItem(DEFAULT_I_D_PRODUIT)))
    ...
    void getProduit() throws Exception {
        ...
        restProduitMockMvc
            ...
            .andExpect(jsonPath("$.iDProduit").value(DEFAULT_I_D_PRODUIT))
    ...
    void putNewProduit() throws Exception {
        ...
        Produit testProduit = produitList.get(produitList.size() - 1);
        assertThat(testProduit.getiDProduit()).isEqualTo(UPDATED_I_D_PRODUIT);
        assertThat(testProduit.getNom()).isEqualTo(UPDATED_NOM);
        assertThat(testProduit.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testProduit.getPhoto()).isEqualTo(UPDATED_PHOTO);
        assertThat(testProduit.getStock()).isEqualTo(UPDATED_STOCK);
        assertThat(testProduit.getTags()).isEqualTo(UPDATED_TAGS);
        assertThat(testProduit.getTarif()).isEqualTo(UPDATED_TARIF);
    }
    ...
    void partialUpdateProduitWithPatch() throws Exception {
        ...
        partialUpdatedProduit.description(UPDATED_DESCRIPTION).photo(UPDATED_PHOTO).stock(UPDATED_STOCK);
