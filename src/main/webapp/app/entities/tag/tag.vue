<template>
  <div>
    <h2 id="page-heading" data-cy="TagHeading">
      <span v-text="$t('jHipsterExerciseApp.tag.home.title')" id="tag-heading">Tags</span>
    ...
    <div class="alert alert-warning" v-if="!isFetching && tags && tags.length === 0">
      <span v-text="$t('jHipsterExerciseApp.tag.home.notFound')">No tags found</span>
    </div>
    <div class="table-responsive" v-if="tags && tags.length > 0">
      <table class="table table-striped" aria-describedby="tags">
        ...
        <tbody>
          <tr v-for="tag in orderBy(filterBy(tags, filtered), propOrder, reverse === true ? 1 : -1)" :key="tag.id" data-cy="entityTable">
            <td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="jHipsterExerciseApp.tag.delete.question" data-cy="tagDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-tag-heading" v-text="$t('jHipsterExerciseApp.tag.delete.question', { id: removeId })">
