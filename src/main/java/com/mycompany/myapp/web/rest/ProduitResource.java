        ...
        Optional<Produit> result = produitRepository
            ...
            .map(existingProduit -> {
                if (produit.getiDProduit() != null) {
                    existingProduit.setiDProduit(produit.getiDProduit());
                }
                ...
                if (produit.getTags() != null) {
                    existingProduit.setTags(produit.getTags());
                }
                if (produit.getTarif() != null) {
                    existingProduit.setTarif(produit.getTarif());
                }
